...
public class BlockLavaFluid extends BlockFluid{
	
	private String texture, texture2;
    protected static Icon[] theIcon;
	
	public BlockLavaFluid(int par1, String par2, Material mat, String par4) {
		super(par1, mat);
		this.texture = par2;
		this.texture2 = par4;
	   ...
	   public void registerIcons(IconRegister par1IconRegister)
	   {
	    ...
	    {
	        return par0Str == "custom_lava_still" ? BlocksFluid.theIcon[0] : (par0Str == "custom_lava_flowing" ? BlocksFluid.theIcon[1] : null);
	    }
