...
import arima.anotherpack.models.model_ruby_gun;
import arima.anotherpack.models.model_ruby_scythe;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED: {
			...
			if (data[1] != null && data[1] instanceof EntityPlayer) {
				Minecraft.getMinecraft().renderEngine.bindTexture("/mods/anotherpack/textures/items/Scythes/ruby_scythe_2.png");
