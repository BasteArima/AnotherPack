...
public class ZTonesBlocks extends Block {

	private int count;
	private Icon[] icon;
	private String texture;

	public ZTonesBlocks(int id, String name, String texture, int count) {
		super(id, Material.rock);
		this.setUnlocalizedName(name);
		this.texture = "anotherpack:ztones/" + texture;
		this.setCreativeTab(Main.tabAPZtones);
