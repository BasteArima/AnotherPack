...
public class TileEntityRedBeaconRenderer extends TileEntitySpecialRenderer{
    public void renderTileEntityBeaconAt(TileEntityRedBeacon par1TileEntityBeacon, double par2, double par4, double par6, float par8)
    {
        ...
        if (f1 > 0.0F)
        {
            ...
            this.bindTextureByName("/mods/anotherpack/textures/red_beam.png");
    ...
    {
        this.renderTileEntityBeaconAt((TileEntityRedBeacon)par1TileEntity, par2, par4, par6, par8);
    }
}
